...
class ModeScaleGenerator():
    ...
    def get(self):
        ...
        notes_sort[0][1] += "Ionian"
        notes_sort[1][1] += "Dorian"
        notes_sort[2][1] += "Phrygian"
        notes_sort[3][1] += "lydian"
        notes_sort[4][1] += "Mixolydian"
        notes_sort[5][1] += "Aeolian"
        notes_sort[6][1] += "Locrian"
